...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Armazém Aya — Conscientes, Artesanais, Naturais" },
      {
        name: "description",
        content:
          "Produtos artesanais feitos com plantas, saberes tradicionais e cuidado. Sinergia de Ervas e Repelente Natural.",
      },
